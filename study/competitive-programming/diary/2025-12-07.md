...
- [B - Citation](https://atcoder.jp/contests/abc409/tasks/abc409_b)
  - きれいにして再度提出：https://atcoder.jp/contests/abc409/submissions/71528074
  - これはもう一回解く価値のある問題だったな
- [B - Compression](https://atcoder.jp/contests/abc408/tasks/abc408_b)
  - AC: https://atcoder.jp/contests/abc408/submissions/71531430
- [B - P(X or Y)](https://atcoder.jp/contests/abc407/tasks/abc407_b)
  - AC: https://atcoder.jp/contests/abc407/submissions/71532054
- [B - Product Calculator](https://atcoder.jp/contests/abc406/tasks/abc406_b)
  - だいぶむずかったぞ・・・式変形しないといけないという頭がなかったなぁ・・・
- [C - Bipartize](https://atcoder.jp/contests/abc427/tasks/abc427_c)
  - これは全くの初見なのですぐ解説を見る
  - キーワード
    - 単純グラフ
      - <img src="../img/2025-12-07_image-2.png" alt="alt text" width="320" height="180">
    - 二部グラフ
      - <img src="../img/2025-12-07_image-1.png" alt="alt text" width="320" height="180">
    - forを入れ替えてみるという考え方が重要かもしれない
      - <img src="../img/2025-12-07_image-3.png" alt="alt text" width="320" height="180">
    - ビット全探索
      - まだ一ミリもしらん・・・！
...
B問題もDifficulty200ぐらいになると今の知識では解けない問題が出てきてかなりきついというのを感じた。\
まだまだ茶色への道の遠さを感じた・・・


名言:https://www.youtube.com/watch?v=xu8Ex2Mi4Kk&t=2523s
>道具が先に出てくるのは結構まずい傾向ではありますね、これがしたいからこういう道具を使うという方向でモノを考えた方がおそらくいろんな問題を解けるようになるのではないかと思います。
